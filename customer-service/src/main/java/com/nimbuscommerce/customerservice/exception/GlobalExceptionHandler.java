package com.nimbuscommerce.customerservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> handlePatientNotFoundException(CustomerNotFoundException ex) {
